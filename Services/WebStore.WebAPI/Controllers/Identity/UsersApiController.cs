...
public class UsersApiController : ControllerBase
{
    ...
    public async Task<string> SetUserNameAsync([FromBody] User user, string name)
    {
        ...
        // не сделано так в случае если MS изменит логику, то ничего не пострадает
        //user.UserName = name;
    ...
    public async Task<DateTimeOffset?> SetLockoutEndDateAsync([FromBody] SetLockOut LockoutInfo)
    {
